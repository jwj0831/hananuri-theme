...
/**
 * Template Name: Overseas Biz Vietnam Page
 *
	...
	<div class="subpage_stretched">
		<div class="breadcrumb_stretched">
			<div class="breadcrumb_fixed">
				<p>
					<img src='<?php bloginfo('template_url'); ?>/images/subpage/sub_home.gif'> 홈 > 북한∙해외사업 > 해외사업 > 베트남사업
				</p>
			</div>
		</div>
		...
		<div class="subpage_fixed">
			...
			<div id="content">
				<img src='<?php bloginfo('template_url'); ?>/images/subpage/sub2/sub2_overseas2.gif' usemap="#Overseas_Map">
