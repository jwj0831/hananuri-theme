...
/**
 * Template Name: Overseas Biz India Page
 *
	...
	<div class="subpage_stretched">
		<div class="breadcrumb_stretched">
			<div class="breadcrumb_fixed">
				<p>
					<img src='<?php bloginfo('template_url'); ?>/images/subpage/sub_home.gif'> 홈 > 북한∙해외사업 > 해외사업 > 인도사업
				</p>
			</div>
		</div>
			...
			<div id="content">
				...
				<div class="new_contents">
					<?php
						...
						query_posts(array(
							'cat' => getOverseasBizIndiaCategoryNum(),
							'posts_per_page' => 3,
							'paged' => $paged
							)					
						);
