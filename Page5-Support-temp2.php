<?php /**
 * Template Name: Support Page Temp 2
 *
			...
			<div id="content">
				...
				<script>
					$(document).ready(function() {
						$('#ajax-result').load("/hiddenforsecurity/wordpress/wp-content/themes/hananuri_v1/donation_ajax.php", {'num' : 2}, null); //initial data to load
